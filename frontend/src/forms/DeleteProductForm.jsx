...
export function DeleteProductForm({handleDeleteProduct, product}) {

    const [toggleDelete, setToggleDelete] = useState(false);

    return (<>            
            <div className="block hover:cursor-pointer text-red-500" onClick={() => setToggleDelete(!toggleDelete)}>Delete
            </div>
            { 
                toggleDelete ? 
                (
